  ...
  <div class="inquiry-tab-wrapper">
    <b-row>
      <b-col cols="12">
        ...
        <b-input
          ...
          v-model="inputs.inquiry.full_name"
    ...
    <b-row>
      <b-col cols="12">
        ...
        <b-form-textarea
          v-validate="'required'"
          data-vv-as="Message"
          v-model="inputs.inquiry.message"
          maxlength="400"
    ...
    <b-row class="justify-content-center my-3">
      ...
      <b-col cols="12" md="3">
        <custom-button
          @click="uploadFile"
          class="browse-button mt-2 smallbtn"
          :inverseColor="true"
        >
      ...
      <b-col cols="12" md="3">
        <custom-button
          @click="resetFile"
          class="reset-button mt-2 smallbtn"
          :inverseColor="false"
        >
...
<script src="./InquiryTab.js" />
<style src="./InquiryTab.scss" lang="scss" />
